...
var EKool = /** @class */ (function () {
    ...
    EKool.prototype.addTokens = function(accessToken, refreshToken){
        if (accessToken) {
            this.accessToken = accessToken;
        }
        if (refreshToken) {
    ...
    EKool.prototype.getTasksForStudent = function (start, end) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['todolist', String(this.studentID), start, end])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getLessonsForStudents = function (start, end) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['lessons', String(this.studentID), start, end])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getTimetableForStudents = function (start, end) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['timetable', String(this.studentID), start, end])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getLessonWithDescriptionForAbsenceId = function (absenceID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['lessonEventByAbsence', String(this.studentID), String(absenceID)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getGradeDetailData = function (gradeID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['grades', String(this.studentID), String(gradeID)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getSubjectGradeForStudentSubject = function (subjectID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['subjGrade', String(this.studentID), String(subjectID)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getFeedItem = function (eventId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['feeditem', String(this.studentID), String(eventId)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getFeedForStudent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['feed', String(this.studentID)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getDilBehGradesForTypeId = function (typeId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['grades/dilbeh', String(this.studentID), String(typeId)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getSubjectWithCoursesAndJournals = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['gradesheet', String(this.studentID)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getGradesForTermByJournal = function (selectedJournalId, gradeId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['gradesheet', String(this.studentID), 'consolidated', String(selectedJournalId), 'term', String(gradeId)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype.getConsolidatedGradesByJournal = function (journalId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._dataMiner(['gradesheet', String(this.studentID), 'consolidated', String(journalId)])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EKool.prototype._dataMiner = function (pathElements, accessToken, url) {
        if (accessToken === void 0) { accessToken = this.accessToken; }
        if (url === void 0) { url = API_URL; }
        return __awaiter(this, void 0, void 0, function () {
            var defaultPayload, headers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
